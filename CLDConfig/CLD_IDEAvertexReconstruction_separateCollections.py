...
if CONFIG["InputMode"] == "EDM4hep":
    ...
    EDM4hep2Lcio.collNameMapping = {
        ...
        'VTXOBCollection':                 'VTXOBCollection',
...
VXDInnerBarrelDigitiser = MarlinProcessorWrapper("VXDInnerBarrelDigitiser")
VXDInnerBarrelDigitiser.OutputLevel = WARNING
VXDInnerBarrelDigitiser.ProcessorType = "DDPlanarDigiProcessor"
VXDInnerBarrelDigitiser.Parameters = {
                                 "IsStrip": ["false"],
                                 "ResolutionU": ["0.003", "0.003", "0.003"],
                                 "ResolutionV": ["0.003", "0.003", "0.003"],
...
VXDOuterBarrelDigitiser = MarlinProcessorWrapper("VXDOuterBarrelDigitiser")
VXDOuterBarrelDigitiser.OutputLevel = WARNING
VXDOuterBarrelDigitiser.ProcessorType = "DDPlanarDigiProcessor"
VXDOuterBarrelDigitiser.Parameters = {
                                 "IsStrip": ["false"],
                                 "ResolutionU": ["0.014", "0.014"], # 50 µm/sqrt(12)
                                 "ResolutionV": ["0.043", "0.043"], # 150 µm/sqrt(12)
                                 "SimTrackHitCollectionName": ["VTXOBCollection"],
                                 "SimTrkHitRelCollection": ["VXDOBTrackerHitRelations"],
                                 "SubDetectorName": ["VTXOB"],
                                 "TrackerHitCollectionName": ["VXDOBTrackerHits"]
                                 }
...
MyTruthTrackFinder.Parameters = {
                                 ...
                                 "SimTrackerHitRelCollectionNames": ["VXDIBTrackerHitRelations", "VXDOBTrackerHitRelations", "InnerTrackerBarrelHitsRelations", "OuterTrackerBarrelHitsRelations", "VXDEndcapTrackerHitRelations", "InnerTrackerEndcapHitsRelations", "OuterTrackerEndcapHitsRelations"],
                                 "TrackerHitCollectionNames": ["VXDIBTrackerHits", "VXDOBTrackerHits", "ITrackerHits", "OTrackerHits", "VXDEndcapTrackerHits", "ITrackerEndcapHits", "OTrackerEndcapHits"],
...
if "_IDEAvertex_" in  geoservice.detectors[0]:
    CT_MAX_DIST = "0.20;"  # semi-colon is important!
...
MyConformalTracking.Parameters = {
                                  ...
                                  "RelationsNames": ["VXDIBTrackerHitRelations", "VXDOBTrackerHitRelations", "VXDEndcapTrackerHitRelations", "InnerTrackerBarrelHitsRelations", "OuterTrackerBarrelHitsRelations", "InnerTrackerEndcapHitsRelations", "OuterTrackerEndcapHitsRelations"],
                                  ...
                                  [
                                      "[VXDBarrel]",
                                      "@Collections", ":", "VXDIBTrackerHits,", "VXDOBTrackerHits",
                                      ...
                                      "[LowerCellAngle1]",
                                      "@Collections", ":", "VXDIBTrackerHits,", "VXDOBTrackerHits,", "VXDEndcapTrackerHits",
                                      ...
                                      "@Functions", ":", "CombineCollections,", "ExtendTracks",
                                      "[Displaced]",
                                      "@Collections", ":", "VXDIBTrackerHits,", "VXDOBTrackerHits,", "VXDEndcapTrackerHits,", "ITrackerHits,", "OTrackerHits,", "ITrackerEndcapHits,", "OTrackerEndcapHits",
                                  ...
                                  "TrackerHitCollectionNames": ["VXDIBTrackerHits", "VXDOBTrackerHits", "VXDEndcapTrackerHits", "ITrackerHits", "OTrackerHits", "ITrackerEndcapHits", "OTrackerEndcapHits"],
                                  "trackPurity": ["0.7"]
                                  }
...
MyClicEfficiencyCalculator.Parameters = {
                                         ...
                                         "TrackerHitCollectionNames": ["VXDIBTrackerHits", "VXDOBTrackerHits", "VXDEndcapTrackerHits", "ITrackerHits", "OTrackerHits", "ITrackerEndcapHits", "OTrackerEndcapHits"],
                                         "TrackerHitRelCollectionNames": ["VXDIBTrackerHitRelations", "VXDOBTrackerHitRelations", "VXDEndcapTrackerHitRelations", "InnerTrackerBarrelHitsRelations", "OuterTrackerBarrelHitsRelations", "InnerTrackerEndcapHitsRelations", "OuterTrackerEndcapHitsRelations"],
...
MyRecoMCTruthLinker.Parameters = {
                                  ...
                                  "SimTrackerHitCollections": ["VTXIBCollection", "VTXOBCollection", "VTXDCollection", "InnerTrackerBarrelCollection", "OuterTrackerBarrelCollection", "InnerTrackerEndcapCollection", "OuterTrackerEndcapCollection"],
                                  "TrackCollection": ["SiTracks_Refitted"],
                                  "TrackMCTruthLinkName": ["SiTracksMCTruthLink"],
                                  "TrackerHitsRelInputCollections": ["VXDIBTrackerHitRelations", "VXDOBTrackerHitRelations", "VXDEndcapTrackerHitRelations", "InnerTrackerBarrelHitsRelations", "OuterTrackerBarrelHitsRelations", "InnerTrackerEndcapHitsRelations", "OuterTrackerEndcapHitsRelations"],
...
algList.append(VXDInnerBarrelDigitiser)
algList.append(VXDOuterBarrelDigitiser)
